...
class TemplateService:
    ...
    def resolve(self, user_query: str) -> tuple[str, dict, str, str]:
        """Resolve a user question to a pre-written SQL template + bind params.

        Returns: (sql_string, params_dict, template_key, reasoning_string)
        ...
        if tool_name == "afe_financial":
            ...
            return sql, params, tool_args.get("template", "afe_financial"), reasoning
